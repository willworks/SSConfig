...
#bin下载地址
BIN=http://soft.91yun.org/soft/serverspeeder/bin/Ubuntu/14.04/3.13.0-74-generic/x64/3.11.20.4/serverspeeder_3246
...
rv=Ubuntu_14.04_3.13.0-74-generic
...
echo "开始下载bin运行文件。。。。"
echo "======================================"
curl $BIN -o 91yunserverspeeder/apxfiles/bin/acce-3.10.61.0-[Ubuntu_14.04_3.13.0-74-generic] || { echo "下载bin运行文件失败，请检查";exit 1; }
